...
public class DividerGridItemDecoration extends RecyclerView.ItemDecoration {
     ...
     */
    public DividerGridItemDecoration(Context context, int dividerHight, int dividerColor,int spanCount) {
        this.spacCount=spanCount;
     ...
     */
    public DividerGridItemDecoration(Context context, int dividerHight, Drawable dividerDrawable,int spanCount) {
        this.spacCount=spanCount;
